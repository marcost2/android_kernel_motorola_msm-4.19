		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	struct cs35l36_private *cs35l36 = snd_soc_component_get_drvdata(component);
	u32 reg;
	int ret = 0;
...
static int cs35l36_codec_set_sysclk(struct snd_soc_component *component,
				 ...
				 struct snd_soc_dai *dai)
{
	...
	if ((cs35l36->clksrc == CS35L36_PLLSRC_SCLK) &&
		...
		ret = cs35l36_codec_set_sysclk(component, CS35L36_PLLSRC_SCLK, 0,
			sclk_rate, 0);
		if (ret != 0) {
...
static int cs35l36_codec_probe(struct snd_soc_component *component)
{
	struct cs35l36_private *cs35l36 = snd_soc_component_get_drvdata(component);
...
static struct snd_soc_component_driver soc_component_dev_cs35l36 = {
			      ...
			      const struct i2c_device_id *id)
{
	...
	ret = devm_snd_soc_register_component(dev, &soc_component_dev_cs35l36, cs35l36_dai,
